...
<p>
    ...
    <asp:DropDownList ID="ddl_Facultad" runat="server" Height="27px" Width="150px">
    </asp:DropDownList>
</p>
<p>
    <asp:Label ID="Label8" runat="server" Text="Carrera:"></asp:Label>
    <asp:DropDownList ID="ddl_Carrera" runat="server" Height="27px" Width="150px">
    </asp:DropDownList>
</p>
<p>
    <asp:Label ID="Label9" runat="server" Text="Índice:"></asp:Label>
    <asp:TextBox ID="txt_Indice" runat="server"></asp:TextBox>
</p>
<p>
...
<p>
    ...
    <asp:TextBox ID="txt_Estatus" runat="server"></asp:TextBox>
</p>
<p>&nbsp;</p>
<p>
